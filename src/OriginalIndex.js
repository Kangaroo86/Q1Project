...
function iconBox() {
  const node = div(
    ...
    div(
      ...
      div(
        { class: 'card' },
        div({ class: 'card-image' }, img({ id: 'test' })),
        div(
          { class: 'card-content' },
          p({ class: 'card-title', id: 'teamName' })
        ),
    ...
    div(
      ...
      div(
        ...
        table(
          ...
          tbody(
            tr(
              td(img({ id: 'topPlayerA' })),
              td({ id: 'playerA_PPG' }),
              td({ id: 'playerA_Rebounds' }),
              td({ id: 'playerA_Assists' }),
              td({ id: 'playerA_Steals' })
            ),
            tr(
              td(img({ id: 'topPlayerB' })),
              td({ id: 'playerB_PPG' }),
              td({ id: 'playerB_Rebounds' }),
              td({ id: 'playerB_Assists' }),
              td({ id: 'playerB_Steals' })
            ),
            tr(
              td(img({ id: 'topPlayerC' })),
              td({ id: 'playerC_PPG' }),
              td({ id: 'playerC_Rebounds' }),
              td({ id: 'playerC_Assists' }),
              td({ id: 'playerC_Steals' })
            )
          ) //tbody
        ) //table
      ) //card horizontal
